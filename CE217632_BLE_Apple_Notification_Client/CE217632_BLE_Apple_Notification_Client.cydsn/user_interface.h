...
/* Set Simulation LED  */
#define Ringing_LED_Write(value)                                                        \
                do{                                                                     \
                    Cy_GPIO_Write(Ringing_LED_0_PORT, Ringing_LED_0_NUM, value);        \
                }while(0u)

#define Ringing_LED_INV()     Cy_GPIO_Inv(Ringing_LED_0_PORT, Ringing_LED_0_NUM)        
