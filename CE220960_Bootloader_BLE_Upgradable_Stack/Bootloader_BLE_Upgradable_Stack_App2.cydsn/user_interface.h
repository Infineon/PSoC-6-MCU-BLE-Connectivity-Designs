...
/* CapsLock LED  */
#define CapsLock_LED_Write(value)                                                           \
    do {                                                                                    \
        Cy_GPIO_Write(CapsLock_LED_0_PORT, CapsLock_LED_0_NUM, value);                      \
    } while(0)

#define CapsLock_LED_INV()  Cy_GPIO_Inv(CapsLock_LED_0_PORT, CapsLock_LED_0_NUM)
