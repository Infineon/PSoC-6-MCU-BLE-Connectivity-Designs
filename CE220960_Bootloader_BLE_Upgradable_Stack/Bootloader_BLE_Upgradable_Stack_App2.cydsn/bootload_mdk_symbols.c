...
__cy_app_core1_start_addr   EQU __cpp(CY_APP2_CORE1_FLASH_ADDR)
...
__cy_app_verify_start     EQU __cpp(CY_APP2_CORE0_FLASH_ADDR)
__cy_app_verify_length    EQU __cpp(CY_APP2_CORE0_FLASH_LENGTH + CY_APP2_CORE1_FLASH_LENGTH - __CY_BOOT_SIGNATURE_SIZE)
}
