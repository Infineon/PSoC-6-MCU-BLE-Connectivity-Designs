...
/* Navigation LED  */
#define Navigation_LED_Write(value)                                                 \
    do{                                                                             \
        Cy_GPIO_Write(Navigation_LED_0_PORT, Navigation_LED_0_NUM, value);          \
    }while(0)

#define Navigation_LED_INV()  Cy_GPIO_Inv(Navigation_LED_0_PORT, Navigation_LED_0_NUM)        
